						...
						<h1>Subject for Replacement</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($connection,"select * from book where status = 'Subject for Replacement'")or die(mysql_error());
									while($row=mysqli_fetch_array($user_query)){
									$id=$row['book_id'];  
									$cat_id=$row['category_id'];

											$cat_query = mysqli_query($connection,"select * from category where category_id = '$cat_id'")or die(mysql_error());
