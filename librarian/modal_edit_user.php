	...
	mysqli_query($connection,"update users set username='$username', password='$password' , firstname = '$firstname' , lastname = '$lastname'  where user_id='$user_id'")or die(mysqli_error()); ?>
	<script>
